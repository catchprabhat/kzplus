...
var require_serverless = __commonJS({
  "node_modules/@netlify/neon/node_modules/@neondatabase/serverless/index.js"(exports, module) {
    "use strict";
...
`);
    ...
    var St = z(() => {
      ...
      a(v, "Socket"), _(v, "defaults", {
        ...
        fetchEndpoint: a((t, n, i) => {
          let s;
          return (i == null ? void 0 : i.jwtAuth) ? s = t.replace(ws, "apiauth.") : s = t.replace(ws, "api."), "https://" + s + "/sql";
        }, "fetchEndpoint"),
    ...
    var Ts = I((At) => {
      ...
      var D = en(), ac = _s(), un = 1, uc = 4, As = un + uc, Cs = y.allocUnsafe(0), hn = class hn {
        constructor(e) {
          if (this.buffer = Cs, this.bufferLength = 0, this.bufferOffset = 0, this.reader = new ac.BufferReader(), (e == null ? void 0 : e.mode) === "binary") throw new Error("Binary mode not supported yet");
    ...
    function An(r, {
      ...
      async function ye(A, g, P) {
        ...
        !Array.isArray(
          g
        ) && (g == null ? void 0 : g.authToken) !== void 0 && (Ee = g.authToken);
    ...
    var In = class In extends Lt.Pool {
      ...
      query(t, n, i) {
        ...
        try {
          ...
          An(h, { fullResults: true, arrayMode: t.rowMode === "array" })(l, d, { types: t.types ?? ((_a = this.options) == null ? void 0 : _a.types) }).then((C) => i(void 0, C)).catch((C) => i(
            C
          ));
        } catch (o) {
          i(o);
...
var require_dist = __commonJS({
  "node_modules/@netlify/neon/dist/index.js"(exports) {
...
@neondatabase/serverless/index.js:
  ...
  *)
*/
//# sourceMappingURL=@netlify_neon.js.map
