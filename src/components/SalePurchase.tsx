  ...
  const carsForSale: CarForSale[] = [
    {
      ...
      description: 'Well-maintained Crysta with full service history. Second owner, garage kept. All maintenance done at authorized service center.',
      features: ['Air Conditioning', 'GPS Navigation', 'Bluetooth', 'Backup Camera', 'Heated Seats', 'Cruise Control'],
      images: [
        '/images/ka-crysta/1.jpg',
        '/images/ka-crysta/2.jpg',
        '/images/ka-crysta/3.jpg',
        '/images/ka-crysta/4.jpg',
        '/images/ka-crysta/5.jpg',
        '/images/ka-crysta/6.jpg',
        '/images/ka-crysta/7.jpg',
      ],
      condition: 'excellent',
      ...
      ownerDetails: {
        name: 'Prabhat Padhy',
        email: 'catchprabhat@gmail.com',
        phone: '+91-9916231415',
        whatsapp: '+91-9916231415',
      ...
      documents: {
        registration: 'rc_toyota_crysta.pdf',
